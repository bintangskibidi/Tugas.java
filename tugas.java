...
class MenuExample {
    ...
    public void secretMenu(Scanner sc) {
        while (true) {
            ...
            // Memeriksa panjang kode akses
            if (kodeAkses.length() < 7 || kodeAkses.length() > 10) {
                System.out.println("Kode harus lebih dari 7 karakter dan kurang dari 10 karakter.");
                continue;
            }
    
            // Memeriksa apakah kode akses benar
            if (!kodeAkses.equals("12345678")) {
